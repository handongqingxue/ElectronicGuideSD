...
.add_sp_sd_map_dialog_div .toolbar{
	height:32px;
}
.add_sp_sd_map_dialog_div .toolbar .row_div{
	margin-top: 5px;
}
.add_sp_sd_map_dialog_div .toolbar .xsbq_span{
	margin-left: 13px;
}
...
function initAddSpSDMapDialogDiv(){
	addSpSdMDialog=$("#add_sp_sd_map_dialog_div").dialog({
		...
		toolbar:"#add_sp_sd_map_dialog_div #toolbar",
		height:730,
		top:10,
		left:20,
		buttons:[
	...
	<div class="add_sp_canvas_bg_div" id="add_sp_canvas_bg_div">
		<div class="add_sp_canvas_div" id="add_sp_canvas_div">
			...
			<div class="add_sp_canvas_dialog_div" id="add_sp_canvas_dialog_div">
				...
				<div class="add_sp_sd_map_dialog_div" id="add_sp_sd_map_dialog_div">
