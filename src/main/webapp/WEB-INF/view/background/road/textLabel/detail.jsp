...
.detail_tl_sd_map_dialog_div .toolbar{
	height:32px;
}
.detail_tl_sd_map_dialog_div .toolbar .row_div{
	margin-top: 5px;
}
.detail_tl_sd_map_dialog_div .toolbar .xsbq_span{
	margin-left: 13px;
}
...
function initDetailTLSDMapDialogDiv(){
	detailTLSDMDialog=$("#detail_tl_sd_map_dialog_div").dialog({
		title:"景区地图",
		toolbar:"#detail_tl_sd_map_dialog_div #toolbar",
	...
	<div class="detail_tl_canvas_bg_div" id="detail_tl_canvas_bg_div">
		<div class="detail_tl_canvas_div" id="detail_tl_canvas_div">
			...
			<div class="detail_tl_canvas_dialog_div" id="detail_tl_canvas_dialog_div">
				...
				<div class="detail_tl_sd_map_dialog_div" id="detail_tl_sd_map_dialog_div">
